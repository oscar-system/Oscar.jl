@doc raw"""
    visualize(P::Union{Polyhedron{T}, Cone{T}, PolyhedralFan{T}, PolyhedralComplex{T}, SubdivisionOfPoints{T}}) where T<:Union{QQFieldElem, Float64, EmbeddedElem}
...
"""
function visualize(P::Union{Polyhedron{T}, Cone{T}, PolyhedralFan{T}, PolyhedralComplex{T}}) where T<:Union{QQFieldElem, Float64, EmbeddedElem}
  d = ambient_dim(P)
  b = P isa Polyhedron
  if b && d == 4
...
function visualize(P::SubdivisionOfPoints{T}) where T<:Union{QQFieldElem, Float64, EmbeddedElem}
  d = ambient_dim(P)
