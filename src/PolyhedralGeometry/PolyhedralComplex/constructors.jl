...
- `vr::MatrixUnion`: The points whose convex hulls make up the polyhedral
...
- `L::MatrixUnion`: Generators of the lineality space of the polyhedral complex.
...
function PolyhedralComplex{T}(
                ...
                L::Union{MatrixUnion, Nothing} = nothing;
