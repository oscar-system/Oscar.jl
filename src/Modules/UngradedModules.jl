...
Construct the submodule generated by the rows of `A`. The surrounding free
...
Note: The surrounding free module of the submodule is constructed by the function and therefore
...
Check for equality. For two submodules of free modules to be equal their surrounding 
