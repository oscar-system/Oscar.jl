...
@doc Markdown.doc"""
    sub(F::FreeMod{T}, A::MatElem{T}, task::Symbol = :none) where {T} 
...
If `task = :only_morphism`, return only the inclusion map.
"""
function sub(F::FreeMod{T}, A::MatElem{T}, task::Symbol = :none) where {T} 
...
@doc Markdown.doc"""
    quo(F::FreeMod{T}, A::MatElem{T}, task::Symbol = :none) where {T}
...
If `task = :only_morphism`, return only the projection map.
"""
function quo(F::FreeMod{T}, A::MatElem{T}, task::Symbol = :none) where {T}
