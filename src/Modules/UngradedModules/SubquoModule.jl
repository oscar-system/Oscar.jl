...
Free module of rank 1 over localized ring
...
Free module of rank 1 over localized quotient of multivariate polynomial ring
...
Homogeneous module homomorphism
  from graded free module Rg^3([-2]) of rank 3 over Rg
  to graded free module Rg^2([-1]) of rank 2 over Rg
defined by
  e[1] -> y*e[1]
  e[2] -> (x + y)*e[1] + y*e[2]
  e[3] -> z*e[2]
...
Homogeneous module homomorphism
  from graded free module Rg^1([-2]) of rank 1 over Rg
  to graded free module Rg^2([-1]) of rank 2 over Rg
defined by
  e[1] -> y*e[1] + z*e[2]
...
function show(io::IO, SQ::SubquoModule)
  ...
  if is_graded(SQ)
      if isdefined(SQ, :quo) && !iszero(SQ.quo)
          ...
          println(io_compact, " of submodule of ", Lowercase(), SQ.F,
                              " generated by", Lowercase(), SQ.sub)
          print(io_compact, "by submodule of ", Lowercase(), SQ.F,
                            " generated by", Lowercase(), SQ.quo)
      else
          print(io_compact, "Graded submodule of ", Lowercase(), SQ.F)
          println(io_compact, Lowercase(), SQ.sub)
...
function show_subquo(SQ::SubquoModule)
  #@show_name(io, SQ)
  #@show_special(io, SQ)
  io_compact = IOContext(stdout, :supercompact => true)
  if isdefined(SQ, :quo)
...
1 -> x^2*e[1]
2 -> y^3*e[1]
3 -> z^4*e[1], Hom: M -> graded subquotient of submodule of F generated by
1 -> x*e[1]
2 -> y*e[1]
by submodule of F generated by
1 -> x^2*e[1]
2 -> y^3*e[1]
3 -> z^4*e[1], Hom: N -> graded subquotient of submodule of F generated by
1 -> x*e[1]
2 -> y*e[1]
by submodule of F generated by
1 -> x^2*e[1]
...
1 -> x^2*e[1]
2 -> y^3*e[1]
3 -> z^4*e[1], Hom: subquotient of
1 -> -x*y*e[1]
2 -> x*z^4*e[1]
by
1 -> x^2*e[1]
2 -> y^3*e[1]
3 -> z^4*e[1] -> M, Hom: subquotient of
1 -> -x*y*e[1]
2 -> x*z^4*e[1]
by
1 -> x^2*e[1]
...
1 -> x^2*e[1]
2 -> y^3*e[1]
3 -> z^4*e[1] -> M, Hom: graded subquotient of submodule of F generated by
1 -> -x*y*e[1]
2 -> x*z^4*e[1]
by submodule of F generated by
1 -> x^2*e[1]
