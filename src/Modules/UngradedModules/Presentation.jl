...
Homogeneous module homomorphism
  ...
  to graded free module Rg^0 of rank 0 over Rg
defined by
  e[1] -> 0
  e[2] -> 0
  e[3] -> 0
...
Homogeneous module homomorphism
  from graded free module Rg^1([-1]) + Rg^2([-2]) of rank 3 over Rg
  to graded free module Rg^1([-1]) + Rg^2([-2]) of rank 3 over Rg
defined by
  e[1] -> e[1]
  e[2] -> e[2]
  e[3] -> e[3]
...
julia> map(p,1)
Homogeneous module homomorphism
  from graded free module Rg^0 of rank 0 over Rg
  to graded free module Rg^1([-1]) + Rg^2([-2]) of rank 3 over Rg
defined by
...
julia> map(P,0)
Homogeneous module homomorphism
  from graded free module Rg^2([-1]) of rank 2 over Rg
...
julia> map(P,1)
Homogeneous module homomorphism
  from graded free module Rg^2([-2]) + Rg^1([-3]) + Rg^2([-5]) of rank 5 over Rg
...
3 -> y^2*e[2]
4 -> z^4*e[1]
5 -> z^4*e[2], Hom: graded subquotient of submodule of Rg^2 generated by
1 -> e[1]
2 -> e[2]
by submodule of Rg^2 generated by
1 -> x*e[1]
...
Module homomorphism
  from free module of rank 2 over multivariate polynomial ring
...
1 -> e[1]
represented as subquotient with no relations, Hom: N -> M)
