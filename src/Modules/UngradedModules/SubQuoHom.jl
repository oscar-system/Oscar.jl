...
function AbstractAlgebra.show_map_data(io::IO, fmh::SubQuoHom{T1, T2, RingMapType}) where {T1 <: AbstractSubQuo, T2 <: ModuleFP, RingMapType}
  if is_graded(fmh)
    println(io)
...
julia> a = hom(M, N, V)
Module homomorphism
  from subquotient of submodule with 2 generators
  1 -> x*e[1]
  2 -> y*e[1]
  by submodule with 3 generators
  1 -> x^2*e[1]
...
Graded module homomorphism of degree [2]
  from graded subquotient of submodule of F generated by
  1 -> x*e[1]
  2 -> y*e[1]
  by submodule of F generated by
  1 -> x^2*e[1]
  2 -> y^3*e[1]
  3 -> z^4*e[1]
  to graded subquotient of submodule of F generated by
  1 -> x*e[1]
  2 -> y*e[1]
  by submodule of F generated by
  1 -> x^2*e[1]
...
1 -> x^2*e[1]
2 -> y^3*e[1]
3 -> z^4*e[1], Hom: graded subquotient of submodule of F generated by
1 -> x*y^2*e[1]
2 -> x^2*y*e[1]
by submodule of F generated by
1 -> x^2*e[1]
...
julia> incl
Module homomorphism
  from submodule with 1 generator
  1 -> x*z*e[1] - y*z*e[2] + y^2*e[3]
  represented as subquotient with no relations
  to free module of rank 3 over multivariate polynomial ring
```
...
julia> incl
Module homomorphism
  from subquotient of submodule with 3 generators
  1 -> (-x + y^2)*e[1]
  2 -> x*y*e[1]
  3 -> -x*y*e[1]
  by submodule with 3 generators
