...
@doc raw"""
    sub(M::SparseFPModule{T}, V::Vector{<:SparseFPModuleElem{T}}; cache_morphism::Bool=false) where T
...
```
"""
function sub(M::SparseFPModule{T}, V::Vector{<:SparseFPModuleElem{T}}; cache_morphism::Bool=false) where T
...
```
"""
function quo(M::SparseFPModule{T}, V::Vector{<:SparseFPModuleElem{T}}; cache_morphism::Bool=false) where T
