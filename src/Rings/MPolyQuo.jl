...
Given a vector `V` of homogeneous elements of a graded multivariate 
polynomial ring over a field, or of a quotient ring of such a ring,
return a minimal subset of the elements which still generate the subalgebra 
