...
julia> base_ring(a)
Quotient of Multivariate Polynomial Ring in x, y, z over Rational Field by ideal generated by: -x^2 + y, -x^3 + z
```
"""
...
(Quotient of Multivariate Polynomial Ring in x, y over Rational Field by ideal generated by: x^3*y^2 - x^2*y^3, x*y^4 - x*y^2, Map from
Multivariate Polynomial Ring in x, y over Rational Field to Quotient of Multivariate Polynomial Ring in x, y over Rational Field by ideal generated by: x^3*y^2 - x^2*y^3, x*y^4 - x*y^2 defined by a julia-function with inverse
)
...
julia> Q, q = quo(R, ideal(R, [x^3*y^2-y^3*x^2, x*y^4-x*y^2]))
(Quotient of Multivariate Polynomial Ring in x, y over Rational Field by ideal generated by: x^3*y^2 - x^2*y^3, x*y^4 - x*y^2, Map from
Multivariate Polynomial Ring in x, y over Rational Field to Q defined by a julia-function with inverse
)

julia> I = ideal(Q,[x^3*y^4-x+y, x*y+y^2*x])
MPolyQuoIdeal(x^3*y^4 - x + y, x*y^2 + x*y)

julia> J = ideal(Q,[x^3*y^3-x+y, x^2*y+y^2*x])
MPolyQuoIdeal(x^3*y^3 - x + y, x^2*y + x*y^2)
...
(Quotient of Multivariate Polynomial Ring in x, y, z over Rational Field graded by
  x -> [1]
  y -> [1]
  z -> [1] by ideal generated by: x^2*z - y^3, x - y, Map from
Multivariate Polynomial Ring in x, y, z over Rational Field graded by
  ...
  x -> [1]
  y -> [1]
  z -> [1] by ideal generated by: x^2*z - y^3, x - y defined by a julia-function with inverse
)
```
"""
