...
@doc Markdown.doc"""
    intersect(I::MPolyQuoIdeal, Js::MPolyQuoIdeal...)

Return the intersection of two or more ideals.
"""
function intersect(I::MPolyQuoIdeal, Js::MPolyQuoIdeal...)
  singular_assure(I)
  si = I.SI
  for J in Js
    base_ring(J) == base_ring(I) || error("base rings must match")
    singular_assure(J)
    si = Singular.intersection(si, J.SI)
  end
  return MPolyQuoIdeal(base_ring(I), si)
end

#######################################################

@doc Markdown.doc"""
    quotient(I::MPolyQuoIdeal, J::MPolyQuoIdeal)
...
```
"""
function quotient(I::MPolyQuoIdeal, J::MPolyQuoIdeal)
  base_ring(I) == base_ring(J) || error("base rings must match")
  singular_assure(I)
  singular_assure(J)
  return MPolyQuoIdeal(base_ring(I), Singular.quotient(I.SI, J.SI))
end
(::Colon)(I::MPolyQuoIdeal, J::MPolyQuoIdeal) = quotient(I, J)
