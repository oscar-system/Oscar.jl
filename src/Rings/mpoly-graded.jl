...
!!! note
    ...
    for the standard-graded case: compute a wedgrevlex Groebner basis then homogenize its elements.
    ...
    Source: Kreuzer+Robbiano (vol 2) defn 4.4.1, Cor 4.4.9, Tutorial 53(d)
