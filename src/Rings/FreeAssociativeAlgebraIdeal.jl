...
mutable struct FreeAssociativeAlgebraIdeal{T} <: Ideal{T}
  ...
  gb::IdealGens{T}
  deg_bound::Int
  function FreeAssociativeAlgebraIdeal(g::IdealGens{T}, check_groebner_basis::Bool=false) where T <: FreeAssAlgElem
    r = new{T}()
    r.gens = g
...
@doc raw"""
    ideal(R::FreeAssociativeAlgebra, g::Vector{<:FreeAssAlgElem})

Return the two-sided ideal of $R$ generated by $g$.
"""
function ideal(R::FreeAssociativeAlgebra, g::Vector{<:FreeAssAlgElem})
...
AbstractAlgebra.normal_form(f::FreeAssAlgElem, I::FreeAssociativeAlgebraIdeal) = normal_form(f, gens(I))
...
```
"""
function ideal_membership(a::FreeAssAlgElem, I::FreeAssociativeAlgebraIdeal, deg_bound::Int=-1)
...
function Base.in(a::FreeAssAlgElem, I::FreeAssociativeAlgebraIdeal)
