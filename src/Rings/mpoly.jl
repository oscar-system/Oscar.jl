...
function Base.show(io::IO, ::MIME"text/plain", I::MPolyIdeal)
  io = pretty(io)
  println(io, "Ideal")
  println(io, Indent(), "of ", Lowercase(), base_ring(I), Dedent())
  if ngens(I) == 0
...
function Base.show(io::IO, I::MPolyIdeal)
  if get(io, :supercompact, false)
    ...
    io = pretty(io)
    print(io, "Ideal with ", ItemQuantity(ngens(I), "generator"), " in ", Lowercase())
    print(IOContext(io, :supercompact => true), base_ring(I))
  end
end
