...
Given a vector `g` of polynomials in the same parent polynomial ring, return the ideal generated by these polynomials in that ring.

In the decorated case, assure that the entries of `g` are homogeneous if the base ring is graded.

    ideal(R::MPolyRing, g::Vector)

Given a vector `g` of polynomials in `R`, return the ideal generated by these polynomials in `R`.
