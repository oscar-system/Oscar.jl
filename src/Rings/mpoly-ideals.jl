...
2-element Array{Tuple{MPolyIdeal{fmpq_mpoly},MPolyIdeal{fmpq_mpoly},MPolyIdeal{AbstractAlgebra.Generic.MPoly{nf_elem}},Int64},1}:
 (ideal generated by: z^2 + 1, y + 1, ideal generated by: z^2 + 1, y + 1, ideal generated by: z - _a, y + 1, 2)
 (ideal generated by: z^6 + 4*z^3 + 4, y - z^2, ideal generated by: z^3 + 2, y - z^2, ideal generated by: z - _a, y - _a*z, 3)

julia> AP = L[1][3]
ideal generated by: z - _a, y + 1

julia> RAP = base_ring(AP)
Multivariate Polynomial Ring in x, y, z over Number field over Rational Field with defining polynomial x^2 + 1
