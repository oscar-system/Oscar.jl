...
@attr MPolyIdeal{T} function radical(I::MPolyIdeal{T}; eliminate_variables::Bool=true) where {T <: MPolyRingElem}
  if eliminate_variables
    ...
    is_known(I, dim) && (res.dim = dim(I)) # preserve information about the dimension
    return res
  end
...
function is_known(I::Ideal, ::typeof(radical))
...
is_known(I::MPolyIdeal, ::typeof(primary_decomposition)) = has_attribute(I, :primary_decomposition)
...
is_known(I::MPolyIdeal, ::typeof(minimal_primes)) = has_attribute(I, :minimal_primes)
...
@attr Bool function is_prime(I::MPolyIdeal)
  is_known(I, primary_decomposition) && is_one(length(primary_decomposition(I))) && return is_subset(first(primary_decomposition(I))[2], I)
  D = minimal_primes(I)
...
is_known(I::MPolyIdeal, ::typeof(codim)) = is_known(I, dim)
...
is_known(I::MPolyIdeal, ::typeof(is_zero)) = has_attribute(I, :is_zero) || all(is_zero, gens(I))
...
function is_known(I::MPolyIdeal, ::typeof(is_one))
