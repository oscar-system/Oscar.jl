...
the flag Plücker ideal with respect to the degree reverse lexicographical order.
...
function flag_pluecker_ideal(F::Field, dimensions::Vector{Int}, n::Int; minimal::Bool=true)
  ...
  ring, _ = polynomial_ring(F, L; cached=false)
...
function flag_pluecker_ideal(ring::MPolyRing{<: FieldElem}, dimensions::Vector{Int}, n::Int; minimal::Bool=true)
  ...
  @req dimensions == sort(dimensions) "The dimensions must be increasing"
