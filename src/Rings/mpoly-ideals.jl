...
@doc Markdown.doc"""
    ideal(R::MPolyRing, g::Array{<:Any, 1})

Create the ideal generated by the polynomials in `g`, specifying `R` as the ambient ring of the ideal. 
...
```
"""
function ideal(R::MPolyRing, g::Array{<:Any, 1})
...
Return true if `I` is the ideal generated by `1`, false otherwise.
# Examples
```jldoctest
julia> R, (x, y, z) = PolynomialRing(QQ, ["x", "y", "z"])
(Multivariate Polynomial Ring in x, y, z over Rational Field, fmpq_mpoly[x, y, z])
