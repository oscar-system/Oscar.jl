...
```
"""
function cellular_associated_primes(I::MPolyIdeal{fmpq_mpoly}, RQQAb::MPolyRing = PolynomialRing(abelian_closure(QQ)[1], symbols(base_ring(I)))[1])
  #input: cellular binomial ideal
  #output: the set of associated primes of I
  if iszero(I)
     QQAb, = abelian_closure(QQ)
     RQQAb = PolynomialRing(QQAb, symbols(base_ring(I)))[1]
...
function cellular_minimal_associated_primes(I::MPolyIdeal{fmpq_mpoly})
  ...
  P = partial_character_from_ideal(I, R)
  QQAbcl, = abelian_closure(QQ)
  RQQAb = PolynomialRing(QQAbcl, symbols(R))[1]
...
```
"""
function cellular_primary_decomposition(I::MPolyIdeal{fmpq_mpoly}, RQQAb::MPolyRing = PolynomialRing(abelian_closure(QQ)[1], symbols(base_ring(I)))[1])
