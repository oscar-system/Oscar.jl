...
Return true `I` can be generated by polynomials consisting of at most 2 terms, false otherwise.
"""
...
ideal generated by: x[1]*x[5] - x[2]*x[5], x[3]*x[6] - x[4]*x[6], x[5]^2, x[6]^2, x[5]*x[6]
...
Given a binomial ideal `I`, return true if `I` can be generated by differences of monic monomials and monomials.
...
ideal generated by: x^2 - y^3, z^2
...
ideal generated by: x[1]*x[5] - x[2]*x[5], x[3]*x[6] - x[4]*x[6], x[5]^2, x[6]^2, x[5]*x[6], x[5], x[6]
```
"""
...
3-element Array{MPolyIdeal{AbstractAlgebra.Generic.MPoly{Oscar.QabModule.QabElem}},1}:
 ideal generated by: x5, x6
 ideal generated by: x1 - x2, x5, x6
 ideal generated by: x3 - x4, x5, x6
```
"""
...
3-element Array{Tuple{MPolyIdeal{AbstractAlgebra.Generic.MPoly{Oscar.QabModule.QabElem}},MPolyIdeal{AbstractAlgebra.Generic.MPoly{Oscar.QabModule.QabElem}}},1}:
 (ideal generated by: x1*x5 - x2*x5, x3*x6 - x4*x6, x5^2, x6^2, x5*x6, x5, x6, ideal generated by: x5, x6)
 (ideal generated by: x1*x5 - x2*x5, x3*x6 - x4*x6, x5^2, x6^2, x5*x6, x1 - x2, x6, ideal generated by: x1 - x2, x5, x6)
 (ideal generated by: x1*x5 - x2*x5, x3*x6 - x4*x6, x5^2, x6^2, x5*x6, x3 - x4, x5, ideal generated by: x3 - x4, x5, x6)
```
"""
...
3-element Array{Tuple{MPolyIdeal{AbstractAlgebra.Generic.MPoly{Oscar.QabModule.QabElem}},MPolyIdeal{AbstractAlgebra.Generic.MPoly{Oscar.QabModule.QabElem}}},1}:
 (ideal generated by: x1 - x2, x1^3 - 1, x2^2*x3 - x3, x3, x2 - z_3, x1 - z_3, ideal generated by: x1*x2^2 - 1, x2 - z_3, x3)
 (ideal generated by: x1 - x2, x1^3 - 1, x2^2*x3 - x3, x3, x2 + z_3 + 1, x1 + z_3 + 1, ideal generated by: x1*x2^2 - 1, x2 + z_3 + 1, x3)
 (ideal generated by: x2 - 1, x1 - 1, x1*x2 - 1, ideal generated by: x2 - 1, x1 - 1, x1*x2 - 1)
```
"""
