...
3-element Array{MPolyIdeal{AbstractAlgebra.Generic.MPoly{Oscar.QabModule.QabElem}},1}:
 ...
 ideal generated by: x1 + -1 in Q(z_1)*x2, x5, x6
 ideal generated by: x3 + -1 in Q(z_1)*x4, x5, x6
```
"""
...
3-element Array{Tuple{MPolyIdeal{AbstractAlgebra.Generic.MPoly{Oscar.QabModule.QabElem}},MPolyIdeal{AbstractAlgebra.Generic.MPoly{Oscar.QabModule.QabElem}}},1}:
 (ideal generated by: x1*x5 + -1 in Q(z_1)*x2*x5, x3*x6 + -1 in Q(z_1)*x4*x6, x5^2, x6^2, x5*x6, x5, x6, ideal generated by: x5, x6)
 (ideal generated by: x1*x5 + -1 in Q(z_1)*x2*x5, x3*x6 + -1 in Q(z_1)*x4*x6, x5^2, x6^2, x5*x6, x1 + -1 in Q(z_1)*x2, x6, ideal generated by: x1 + -1 in Q(z_1)*x2, x5, x6)
 (ideal generated by: x1*x5 + -1 in Q(z_1)*x2*x5, x3*x6 + -1 in Q(z_1)*x4*x6, x5^2, x6^2, x5*x6, x3 + -1 in Q(z_1)*x4, x5, ideal generated by: x3 + -1 in Q(z_1)*x4, x5, x6)
```
"""
