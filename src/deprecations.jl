...
@deprecate SpecType AffineSchemeType
@deprecate SpecOpenType AffineSchemeOpenSubschemeType
@deprecate LeftSpecType LeftAffineSchemeType
@deprecate RightSpecType RightAffineSchemeType
@deprecate SpecOpenRingType AffineSchemeOpenSubschemeRingType
@deprecate SpecMorType AffineSchemeMorType
@deprecate SpecType1 AffineSchemeType1
@deprecate SpecType2 AffineSchemeType2
@deprecate MySpec MyAffineScheme
@deprecate MySpecMor MyAffineSchemeMor
@deprecate SpecOpen_1 AffineSchemeOpenSubscheme1
@deprecate SpecOpen_2 AffineSchemeOpenSubscheme2
@deprecate SpecOpen_3 AffineSchemeOpenSubscheme3
@deprecate SpecOpen_4 AffineSchemeOpenSubscheme4
@deprecate SpecL AffineSchemeL
@deprecate Specs AffineSchemes
@deprecate SpecOpens AffineSchemeOpenSubschemes
@deprecate SpecOpenRings AffineSchemeOpenSubschemeRings
@deprecate SpecOpenMors AffineSchemeOpenSubschemeMors
@deprecate SpecMors AffineSchemeMors
@deprecate AbsSpecs AbsAffineSchemes
@deprecate _is_open_func_for_schemes_without_specopen _is_open_func_for_schemes_without_affine_scheme_open_subscheme
@deprecate spec_open_ring_type affine_scheme_open_subscheme_ring_type
