...
function projective_space(::Type{NormalToricVariety}, d::Int)
  ...
  set_attribute!(variety, :class_group_with_map, (my_g, hom(torusinvariant_weil_divisor_group(variety), my_g, weights)))
  return variety
end
...
function normal_toric_variety_from_glsm(charges::ZZMatrix)
  ...
  set_attribute!(variety, :class_group_with_map, (G2, map))
  return variety
end
...
function normal_toric_varieties_from_glsm(charges::ZZMatrix)
  ...
  for v in varieties
    ...
    set_attribute!(v, :class_group_with_map, (G2, map))
  end
