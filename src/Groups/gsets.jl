...
@attributes mutable struct GSetByElements{T,S} <: GSet{T,S}
    ...
    function GSetByElements(G::T, fun::Function, seeds; closed::Bool = false, check::Bool = true) where {T<:Union{AbstractAlgebra.Group, FinGenAbGroup}}
...
"""
    gset(G::Union{AbstractAlgebra.Group, FinGenAbGroup}[, fun::Function], seeds, closed::Bool = false, check::Bool = true)
...
```
"""
function gset(G::Union{AbstractAlgebra.Group, FinGenAbGroup}, fun::Function, seeds; closed::Bool = false, check::Bool = true)
...
function as_gset(G::T, fun::Function, Omega) where T<:Union{AbstractAlgebra.Group, FinGenAbGroup}
...
function orbit(Omega::GSetByElements{T, S}, omega::S) where {T<:Union{AbstractAlgebra.Group, FinGenAbGroup}, S}
...
```
"""
@attr Vector{GSetByElements{T,S}} function orbits(Omega::GSetByElements{T,S}) where {T <: Union{AbstractAlgebra.Group, FinGenAbGroup},S}
