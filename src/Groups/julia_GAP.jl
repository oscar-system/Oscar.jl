import Hecke: base_ring, dim, elements, ncols, nrows, order
import GAP: FFE
...
"""
    ncols(x::GAPGroupElem{MatrixGroup})
Return the number of columns of the given matrix.
"""
ncols(x::GAPGroupElem{MatrixGroup}) = GAP.Globals.NrCols(x.X)

"""
    nrows(x::GAPGroupElem{MatrixGroup})
Return the number of rows of the given matrix.
"""
nrows(x::GAPGroupElem{MatrixGroup}) = GAP.Globals.NrRows(x.X)
