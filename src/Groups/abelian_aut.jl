...
"""
    orthogonal_group(T::TorQuadMod, gensOT::Vector{fmpz_mat}) -> AutomorphismGroup{TorQuadMod}

Return the subgroup of the orthogonal group of `G` generated by `gensOT`.
"""
function orthogonal_group(T::TorQuadMod, gensOT::Vector{fmpz_mat}; check=true)
