...
function Base.show(io::IO, ::MIME"text/plain", aut::AutGrpAbTor)
  io = pretty(io)
  T = domain(aut)
  println(io, "Group of automorphisms")
  println(io, Indent(), "of ", Lowercase(), T)
  print(io, Dedent(), "generated by ", ItemQuantity(ngens(aut), "element"))
end

function Base.show(io::IO, aut::AutGrpAbTor)
  if get(io, :supercompact, false)
    print(io, "Group of automorphisms")
  else
    print(io, "Group of automorphisms of ")
    if domain(aut) isa GrpAbFinGen
...
function Base.show(io::IO, ::MIME"text/plain", f::AutGrpAbTorElem)
  io = pretty(io)
  D = domain(parent(f))
  println(io, "Automorphism")
  println(io, Indent(), "of ", Lowercase(), D)
  println(io, Dedent(), "defined by")
  show(io, MIME"text/plain"(), matrix(f))
end

function Base.show(io::IO, f::AutGrpAbTorElem)
  if get(io, :supercompact, false)
    print(io, matrix(f))
  else
    print(io, "Automorphism of ")
    if domain(f) isa GrpAbFinGen
      print(io, "finitely generated abelian group")
    else
      print(io, "finite quadratic module")
    end
    print(io, " with matrix representation ", matrix(f))
  end
end

###############################################################################
#
#  Construtor for GrpAbFinGen
#
###############################################################################
