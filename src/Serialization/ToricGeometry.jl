...
@register_serialization_type NormalToricVariety uses_id [:cox_ring, :class_group, :map_from_torusinvariant_weil_divisor_group_to_class_group, :cohomology_ring, :is_complete, :is_smooth, :is_simplicial]
