push!(upgrade_scripts_set, UpgradeScript(
  v"1.8.0",
  function upgrade_1_8_0(s::UpgradeState, dict::AbstractDict{String, Any})
    ...
    elseif type_name == "IdealGens"
      ...
      upgraded_ordering = upgrade_1_8_0(s, Dict{String, Any}("_type" => dict["_type"]["params"]["ordering_type"],
