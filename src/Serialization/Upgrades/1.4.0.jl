push!(upgrade_scripts_set, UpgradeScript(
  v"1.4.0",
  function upgrade_1_4_0(s::UpgradeState, dict::AbstractDict{String, Any})
    ...
    if haskey(dict, "_type")
      ...
      elseif type_name in ["GlobalTateModel", "HypersurfaceModel", "WeierstrassModel"]
        ...
        dict["attrs"] = Dict{String, Any}()
        for k in keys(upgraded_attr_dict["_type"]["params"])
          k == "key_params" && continue
          dict["attrs"][k] = Dict{String, Any}("_type" => upgraded_attr_dict["_type"]["params"][k], "data" => upgraded_attr_dict["data"][k])
        end
      ...
      elseif type_name == "LieAlgebraModule"
        ...
        if haskey(const_data, "is_standard_module")
          dict["_type"]["params"]["_is_standard_module"] = Dict{String, Any}("_type"=>"Bool", "data" => "true")
        elseif haskey(const_data, "is_dual")
          dict["_type"]["params"]["_is_dual"] = const_data["is_dual"]
        elseif haskey(const_data, "is_tensor_power")
          dict["_type"]["params"]["_is_tensor_power"] = [const_data["is_tensor_power"][1], Dict{String, Any}("_type" => "Base.Int", "data" => const_data["is_tensor_power"][2])]
        ...
        elseif haskey(const_data, "is_symmetric_power")
          dict["_type"]["params"]["_is_symmetric_power"] = [const_data["is_symmetric_power"][1], Dict{String, Any}("_type" => "Base.Int", "data" => const_data["is_symmetric_power"][2])]
        ...
        elseif haskey(const_data, "is_exterior_power")
          dict["_type"]["params"]["_is_exterior_power"] = [const_data["is_exterior_power"][1], Dict{String, Any}("_type" => "Base.Int", "data" => const_data["is_exterior_power"][2])]
      ...
      elseif type_name == "Dict"
        if haskey(dict["_type"]["params"], "value_type")
          ...
          dict["_type"]["params"] = Dict{String, Any}(
          ...
          for (k, v) in dict["_type"]["params"]
            ...
            elseif k == "_coeff" 
              ...
              d[k] = upgrade_1_4_0(s, Dict{String, Any}(
          ...
          if haskey(dict, "_refs")
            dict = Dict{String, Any}(
              "_type" => Dict{String, Any}("name" => "Dict", "params"=>Dict{String, Any}()),
      ...
      elseif type_name in ["Vector", "Set", "Matrix"]
        ...
        elseif all(e -> e isa String, dict["data"])
          ...
          for entry in dict["data"]
            push!(upgraded_entries, upgrade_1_4_0(s, Dict{String, Any}(
              "_type" => subtype,
              "data" => entry
            )))
          end
      ...
      elseif type_name == "Tuple"
        ...
        for (i, subtype) in enumerate(dict["_type"]["params"])
          push!(upgraded_subtypes, upgrade_1_4_0(s, Dict{String, Any}(
            "_type" => subtype,
            "data" => dict["data"][i]
          )))
        end
      ...
      elseif type_name in [
        ...
        if !(dict["_type"]["params"] isa AbstractDict) || dict["_type"]["params"]["_type"] == "QQBarField"
          ...
          if !(dict["_type"]["params"] isa AbstractDict)
            ...
            field = Dict{String, Any}("_type" => "QQBarField")
          end
      ...
      elseif type_name == "TropicalCurve"
        if haskey(dict["data"], "graph")
          dict["_type"] = Dict{String, Any}(
            "name" => type_name,
            "params" => Dict{String, Any}("_type" => "String", "data" => "graph")
          )
