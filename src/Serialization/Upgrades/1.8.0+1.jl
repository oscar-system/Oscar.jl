...
push!(upgrade_scripts_set, UpgradeScript(
  v"1.8.0+1",
  function upgrade_1_8_0_1(s::UpgradeState, dict::AbstractDict{String, Any})
    ...
    if type_name == "PhylogeneticModel"
      ...
      dict["_type"]["params"]["transition_matrix_params"] = Dict{String, Any}("name" => "Matrix", "params" => "Symbol")
      dict["_type"]["params"]["root_distribution_entry_type"] = "QQFieldElem"
      dict["_type"]["params"]["root_distribution_params"] = Dict{String, Any}("name" => "Vector",
                                                              "params" => Dict{String, Any}("name" => "QQFieldElem",
                                                                              "params" => Dict{String, Any}("_type" => "QQField")))
