...
# p-adic valuation
function tropical_variety_prime_singular(I::MPolyIdeal{QQMPolyRingElem}, nu::TropicalSemiringMap{QQField,ZZRingElem}; weighted_polyhedral_complex_only::Bool=false)
    sI = Oscar.singular_generators(I)
