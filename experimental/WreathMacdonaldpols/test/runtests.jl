@testset "wreath macdonald polynomials" begin
  ...
  @test result_p1 == wreath_macs(1,3,(@perm 3 (1,2,3)), [0,1,-1])

  result_p2 =[[1//q^4, 1//q, (q^3 + 1)//q^3, 1//q^2, q, (q^3 + 1)//q^2, (q^3 + 1)//q, 1, q^3],
  ...
  @test result_p2 == wreath_macs(2,3,(@perm 3 ()), [1,-1,0])
end
