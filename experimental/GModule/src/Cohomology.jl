...
Oscar.free_module(M::FinGenAbGroup, n::Int) = free_abelian_group(n)
Oscar.free_module(M::AbstractAlgebra.FPModule, n::Int) = free_module(base_ring(M), n)
Oscar.free_module(M::Oscar.ModuleFP, n::Int) = FreeMod(base_ring(M), n)

Oscar.free_module(C::GModule, n::Int) = free_module(C.M, n)
