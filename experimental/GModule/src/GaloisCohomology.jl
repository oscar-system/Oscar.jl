...
#    @assert all(g->h(action(I1.data[6], I1.data[6].G(I1.data[7].G[1]), g)) == action(I2.data[6], I2.data[6].G(I2.data[7].G[1]), h(g)), gens(I1.data[6].M))
    h = induce_hom_W(I1.data[7], I2.data[7], h) # W1 -> W2
#    @assert all(g->h(action(I1.data[7], I1.data[7].G[1], g)) == action(I2.data[7], I2.data[7].G[1], h(g)), gens(I1.data[7].M))
    @assert is_injective(h)
  end
