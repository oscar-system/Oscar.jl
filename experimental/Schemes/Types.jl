...
@attributes mutable struct ToricCoveredScheme{BRT, 
  ...
  function ToricCoveredScheme(ntv::NormalToricVariety)
    ...
    # TODO: Investigate whether or not we can make use of the Hasse Diagram 
    # to take shortcuts in filling up the remaining glueings. 
    # We conjecture, that the composition of the already existing glueings 
    # is already maximal and so a lot of lengthy computations can be skipped.
