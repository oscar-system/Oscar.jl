...
"""
@attributes mutable struct MaxContactObject{BaseRingType} <: AbsCoveredScheme{BaseRingType}
  ...
  ambient_param_data::IdDict{<:AbsAffineSchme,<:Tuple{Vector{Int},Vector{Tuple{RingElem,Int}},
                       Vector{<:MatrixElem}}}
  ...
  function MaxContactCoveredScheme(
               W<:AbsCoveredScheme,
               Cov<:Covering,
