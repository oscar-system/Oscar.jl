...
@doc raw"""
    DeterminantalGerm(A::MatElem{<:MPolyRingElem}, t::Int, p::Vector{T}; mat_type::Symbol = :generic, check::Bool=true) where T<:Union{Integer, FieldElem}
...
julia> L, _ = localization(R, complement_of_point_ideal(R, [0,0,0,0,0]));

julia> A = L[v w x;  w x y;  x y z]
[v   w   x]
[w   x   y]
[x   y   z]

julia> X_A = DeterminantalGerm(A, 2, mat_type = :symmetric)
Spectrum
  of localization
    of quotient
