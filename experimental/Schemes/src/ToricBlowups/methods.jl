...
# Examples
```jldoctest
julia> X = weighted_projective_space(NormalToricVariety, [1, 2, 3])
Normal toric variety

julia> f = blow_up(X, [-1, -1])
...
julia> cox_ring_group_homomorphism(f, x1^6 + x3^2)
x1^6*e^3 + x3^2*e
```
"""
