...
InstallOtherMethod(IsSymmetric, [IsJuliaMatrixRep], m -> Julia.Oscar.issymmetric(m!.m));
InstallOtherMethod(IsMonomial, [IsJuliaMatrixRep], m -> Julia.Oscar.ismonomial(m!.m));
