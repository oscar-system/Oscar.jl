...
#
#     MatrixGroup(matrices::Vector{<:MatrixElem{T}}) where T <: Union{ZZRingElem, QQFieldElem, nf_elem}
#
# Input: matrices::Vector{<:MatrixElem{T}} where T <: Union{ZZRingElem, QQFieldElem, nf_elem}
...
# ```
# """
function MatrixGroup(matrices::Vector{<:MatrixElem{T}}) where T <: Union{ZZRingElem, QQFieldElem, nf_elem}
