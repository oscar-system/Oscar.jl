...
@doc raw"""
    subgroup_of_pseudo_reflections(G::MatGroup)
...
"""
function subgroup_of_pseudo_reflections(G::MatGroup)
  g = elem_type(G)[]
...
function is_subgroup_of_sl(G::MatGroup)
