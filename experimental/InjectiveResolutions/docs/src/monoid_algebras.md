...
The code for [injective resolutions](Research/ResearchProjects/InjectiveResolutions/injectiveResAlgorithms/Oscar.jl/experimental/InjectiveResolutions/docs/src/injective_resolutions.md) 
and [local cohomology](Research/ResearchProjects/InjectiveResolutions/injectiveResAlgorithms/Oscar.jl/experimental/InjectiveResolutions/docs/src/local_cohomology.md) works with $Q$-graded modules and 
