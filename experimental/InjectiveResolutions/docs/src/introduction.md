...
```jldoctest introExample
julia> I_M = ideal(kQ, [])
Ideal over monoid algebra over rational field with cone of dimension 3
generated by 0 
...
where
 ...
 J^1 = direct sum of
    k{[0, 0, -1] + F - Q}, where p_F = Ideal (x_3, x_4)
    k{[-1, -1, -1] + F - Q}, where p_F = Ideal (x_2, x_3)
    k{[-1, -1, 0] + F - Q}, where p_F = Ideal (x_1, x_2)
    k{[-1, 0, 3] + F - Q}, where p_F = Ideal (x_1, x_4)
 J^2 = direct sum of
    k{[-1, -1, -1] + F - Q}, where p_F = Ideal (x_2, x_3, x_4)
    k{[-5, -4, -1] + F - Q}, where p_F = Ideal (x_1, x_3, x_4)
    k{[-5, -4, -4] + F - Q}, where p_F = Ideal (x_1, x_2, x_4)
    k{[-5, -1, -4] + F - Q}, where p_F = Ideal (x_1, x_2, x_3)
 J^3 = direct sum of
    k{[-2, -1, -1] + F - Q}, where p_F = Ideal (x_1, x_2, x_3, x_4)
...
Sector partition of the 1st local cohomology module supported on ideal (x_1, x_2) of
 Graded submodule of kQ^1 with 1 generator
  1: 1*e[1]
represented as subquotient with no relations
...
Sector partition of the 2nd local cohomology module supported on ideal (x_1, x_2) of
 Graded submodule of kQ^1 with 1 generator
  1: 1*e[1]
represented as subquotient with no relations
...
Sector partition of the 3rd local cohomology module supported on ideal (x_1, x_2) of
 Graded submodule of kQ^1 with 1 generator
  1: 1*e[1]
represented as subquotient with no relations
