...
Return the monoid algebra generated by monomials $x^{v_1},\dots,x^{v_n}\in k[x_1,\dots,x_n]$, where $v_1,\dots,v_n$ are the columns of $M_Q$. 
...
Return the monoid algebra generated by monomials $x^{v_1},\dots,x^{v_n}\in k[x_1,\dots,x_n]$, where `V_Q` $= [v_1,\dots,v_n]$.
