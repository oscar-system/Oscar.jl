...
@doc raw"""
    monoid_algebra(A::Union{MPolyRing,MPolyQuoRing})
    
Given a quotient ring of a polynomial ring by ...
...
```
"""
function monoid_algebra(A::MPolyQuoRing)
...
Given a graded polynomial ring $A = k[x_1,\dots,x_n]$ with grading group $G$, return ...
...
```
"""
function monoid_algebra(A::MPolyRing)
  return MonoidAlgebra(A)
end
