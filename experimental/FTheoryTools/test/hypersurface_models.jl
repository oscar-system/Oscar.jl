...
new_poly = gens(R)[4]^3
set_hypersurface_equation(h3, new_poly)

@testset "Test manipulation of hypersurface equation of hypersurface F-theory models" begin
  @test hypersurface_equation(h3) == new_poly
end
...
h4 = hypersurface_model(auxiliary_base_vars, auxiliary_base_grading, d, ambient_space_of_fiber_2, D1, D2, p)
