...
function sophisticated_intersection_product(v::NormalToricVariety, indices::NTuple{4, Int64}, hypersurface_equation::MPolyDecRingElem{QQFieldElem, QQMPolyRingElem}, inter_dict::Dict{Tuple, ZZRingElem}, s_inter_dict::Dict{String, ZZRingElem}, data::NamedTuple)
...
function intersection_from_equivalent_cycle(v::NormalToricVariety, indices::NTuple{4, Int64}, hypersurface_equation::MPolyDecRingElem{QQFieldElem, QQMPolyRingElem}, inter_dict::Dict{Tuple, ZZRingElem}, s_inter_dict::Dict{String, ZZRingElem}, data::NamedTuple)
