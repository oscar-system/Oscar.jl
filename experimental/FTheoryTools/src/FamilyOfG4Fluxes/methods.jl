...
function flux_instance(fgs::FamilyOfG4Fluxes, int_coeffs::Vector{Int64}, rat_coeffs::Vector{Rational{Int64}}; check::Bool = true)
...
function flux_instance(fgs::FamilyOfG4Fluxes, int_coeffs::Vector{Any}, rat_coeffs::Vector{Rational{Int64}}; check::Bool = true)
  return flux_instance(fgs, convert(Vector{Int64}, int_coeffs), rat_coeffs, check = check)
end

function flux_instance(fgs::FamilyOfG4Fluxes, int_coeffs::Vector{Int64}, rat_coeffs::Vector{Any}; check::Bool = true)
  return flux_instance(fgs, int_coeffs, convert(Vector{Rational{Int64}}, rat_coeffs), check = check)
end

function flux_instance(fgs::FamilyOfG4Fluxes, int_coeffs::Vector{Any}, rat_coeffs::Vector{Any}; check::Bool = true)
  return flux_instance(fgs, convert(Vector{Int64}, int_coeffs), convert(Vector{Rational{Int64}}, rat_coeffs), check = check)
end
