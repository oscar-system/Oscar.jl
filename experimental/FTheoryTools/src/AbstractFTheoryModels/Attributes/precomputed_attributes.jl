...
@define_model_attribute_getter((gauge_algebra, DirectSumLieAlgebra{QQBarFieldElem}),
  ...
  ```
  """, "See [Gauge Group](@ref gauge_group_data) for more details.")
...
@define_model_attribute_getter(
  (resolution_generating_sections, ResolutionGeneratingSectionsType),
  """
  ```jldoctest
  julia> using Random;
...
@define_model_attribute_getter(
  (weighted_resolution_zero_sections, WeightedResolutionZeroSectionsType),
  """
  ```jldoctest
  julia> using Random;
...
@define_model_attribute_getter(
  (weighted_resolution_generating_sections, WeightedResolutionGeneratingSectionsType),
  """
  ```jldoctest
  julia> using Random;
