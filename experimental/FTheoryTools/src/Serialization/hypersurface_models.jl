...
function save_object(s::SerializerState, h::HypersurfaceModel)
  ...
  save_data_dict(s) do
    ...
    if has_attribute(h, :_ambient_space_divisors_to_be_considered)
      attrs_dict[:_ambient_space_divisors_to_be_considered] = _ambient_space_divisors_to_be_considered(h)
    end
