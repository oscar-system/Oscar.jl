...
function save_object(s::SerializerState, w::WeierstrassModel)
  ...
  save_data_dict(s) do
    for (data, key) in [
        ...
        (tunable_section_parametrization(w), :tunable_section_parametrization),
...
function load_object(s::DeserializerState, ::Type{<: WeierstrassModel}, params::Tuple{NormalToricVariety, NormalToricVariety, MPolyDecRing})
  ...
  model = WeierstrassModel(explicit_model_sections, tunable_section_parametrization, pw, base_space, amb_space)
