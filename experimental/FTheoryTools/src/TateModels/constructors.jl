...
```
"""
global_tate_model(base::NormalToricVarietyType; completeness_check::Bool = true) = global_tate_model(_tate_sections(base), base; completeness_check = completeness_check)


@doc raw"""
    global_tate_model(ais::Vector{T}, base::NormalToricVarietyType; completeness_check::Bool = true) where {T<:MPolyRingElem}
...
```
"""
function global_tate_model(ais::Vector{T}, base::NormalToricVarietyType; completeness_check::Bool = true) where {T<:MPolyRingElem}
