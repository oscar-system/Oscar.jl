...
```
"""
@attr MPolyIdeal{MPolyDecRingElem{QQFieldElem, QQMPolyRingElem}} function irrelevant_ideal(f::FamilyOfSpaces)
...
```
"""
@attr MPolyIdeal{MPolyDecRingElem{QQFieldElem, QQMPolyRingElem}} function ideal_of_linear_relations(f::FamilyOfSpaces)
  ring = coordinate_ring(f)
  variables = gens(ring)
  w = weights(f)
