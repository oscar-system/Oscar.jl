...
function weierstrass_model(base::NormalToricVariety,
  ...
  vs2 = collect(keys(tunable_section_parametrization))
  ...
  model = WeierstrassModel(explicit_model_sections, tunable_section_parametrization, pw, base, ambient_space)
...
function weierstrass_model(auxiliary_base_ring::MPolyRing, auxiliary_base_grading::Matrix{Int64}, d::Int, weierstrass_f::MPolyRingElem, weierstrass_g::MPolyRingElem)
  ...
  # Compute tunable_section_parametrization
  tunable_section_parametrization = Dict{String, MPolyRingElem}()
  ...
  model = WeierstrassModel(explicit_model_sections, tunable_section_parametrization, pw, auxiliary_base_space, auxiliary_ambient_space)
  set_attribute!(model, :partially_resolved, false)
  return model
end
