...
function matricesForOperators(lie_algebra::GAP.Obj, highest_weight::Vector{ZZRingElem}, 
    ...
    matrices_of_operators = GAP.Obj([GAP.Globals.MatrixOfAction(GAPWrap.Basis(M), o) for o in operators], recursive=false)
...
function weights_for_operators(lie_algebra::GAP.Obj, cartan::GAP.Obj, operators::Vector{GAP.Obj})::Vector{Vector{ZZRingElem}}
    """
