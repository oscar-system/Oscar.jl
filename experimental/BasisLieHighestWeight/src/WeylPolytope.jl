...
This extends then further to the left to all coordinates  the annihilator is then the annihilator of the sudmodule generated by all root vectors at the right end of the birational sequence.
"""
