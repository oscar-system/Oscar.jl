function w_to_eps(
  type::String, rank::Int, weight_w_input::Vector{QQFieldElem}
)::Vector{QQFieldElem}
  """
...
function eps_to_w(
  type::String, rank::Int, weight_eps_input::Vector{QQFieldElem}
)::Vector{QQFieldElem}
  """
...
function alpha_to_eps(
  type::String, rank::Int, weight_alpha_input::Vector{QQFieldElem}
)::Vector{QQFieldElem}
  """
...
function eps_to_alpha_BCD(
  type::String, rank::Int, weight_eps::Vector{QQFieldElem}
)::Vector{QQFieldElem}
  """
  for B-D
  """
