function _patchworks2polynomial(hs::Polymake.BigObject; t=QQ(1,2), points::Union{AbstractMatrix, String, Nothing}=nothing)
  R,(x,y,z) = polynomial_ring(QQ, [:x,:y,:z])
  return _patchworks2polynomial(hs, R; t, points)
end
function _patchworks2polynomial(hs::Polymake.BigObject, R::MPolyRing; t=QQ(1,2), points::Union{AbstractMatrix, String, Nothing}=nothing)
...
function _patchwork2polynomial(R::QQMPolyRing, sgns::AbstractVector, exps::ZZMatrix, w::Vector{Int}, delta::Int, t::QQFieldElem)
