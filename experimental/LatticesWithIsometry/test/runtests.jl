...
@testset "Constructors and accessors" begin
  ...
  @test_throws ArgumentError lattice_with_isometry(A4, zero_matrix(QQ, 0, 0))
  ...
  @test order_of_isometry(biproduct(L2, L3)) == lcm(order_of_isometry(L2), order_of_isometry(L3))
end
