...
ideal generated by: 6*x^5*y^3 - 2*x*y^6, 3*x^6*y^2 - 6*x^2*y^5
```
"""
...
julia> Oscar.ring(C)
(Quotient of Multivariate Polynomial Ring in x, y over Rational Field by ideal generated by: -x^3 + x + y^2, Map from
Multivariate Polynomial Ring in x, y over Rational Field to Quotient of Multivariate Polynomial Ring in x, y over Rational Field by ideal generated by: -x^3 + x + y^2 defined by a julia-function with inverse
)
```
"""
