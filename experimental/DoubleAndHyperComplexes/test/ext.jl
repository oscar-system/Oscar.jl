...
@testset "interpretation map for ext elements" begin
  ...
  @test H_tot isa Oscar.TotalComplex{<:OFPModule, <:OFPModuleHom, <:Oscar.HomComplex}
  for i in -10:10
...
@testset "induced morphisms on hom-complexes" begin
  ...
  @test double_ind[0, 0] isa OFPModuleHom
  @test double_ind[-1, 0] isa OFPModuleHom
  @test double_ind[-2, 0] isa OFPModuleHom
  @test double_ind[0, 1] isa OFPModuleHom
  @test double_ind[-1, 1] isa OFPModuleHom
  @test double_ind[-2, 1] isa OFPModuleHom
