...
function kernel(c::HyperComplex{ChainType}, p::Int, i::Tuple) where {ChainType <: OFPModule}
...
function boundary(c::HyperComplex{ChainType}, p::Int, i::Tuple) where {ChainType <: OFPModule}
  I = collect(i)
...
function homology(c::HyperComplex{ChainType}, p::Int, i::Tuple) where {ChainType <: OFPModule}
