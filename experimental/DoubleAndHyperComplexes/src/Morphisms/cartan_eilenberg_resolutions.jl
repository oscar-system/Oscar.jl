...
function (l::MapLifter{T})(Phi::AbsHyperComplexMorphism, I::Tuple) where {T<:OFPModuleHom}
  i = first(I)
...
morphism_type(::Type{T1}, ::Type{T2}) where {T1<:OFPModule, T2<:OFPModule} = OFPModuleHom{<:T1, <:T2}
