...
`AbsMPolyMultSet` and its concrete descendants `MPolyComplementOfKPointIdeal`,
...
julia> U = complement_of_point_ideal(R, [one(K), a])
Complement
  of maximal ideal corresponding to rational point with coordinates (1, a)
