...
Computes the multiplicity of the space germ R via the leading coefficient of the Hilbert-Samuel polynomial.  
...
!!! note "T1-module mimics the steps from sing.lib, T1-basis uses T1-module"
