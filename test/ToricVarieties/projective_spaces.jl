...
@testset "(Weighted) projective spaces (set_attributes = $set_attributes)" for set_attributes in [true, false]
    ...
    @testset "Basic attributes of P2" begin
        ...
        @test domain(map_from_cartier_divisor_group_to_picard_group(P2)) == cartier_divisor_group(P2)
        @test codomain(map_from_cartier_divisor_group_to_picard_group(P2)) == picard_group(P2)
        @test domain(map_from_cartier_divisor_group_to_torusinvariant_divisor_group(P2)) == cartier_divisor_group(P2)
        @test codomain(map_from_cartier_divisor_group_to_torusinvariant_divisor_group(P2)) == torusinvariant_weil_divisor_group(P2)
