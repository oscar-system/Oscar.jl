...
@testset "del Pezzo surfaces (set_attributes = $set_attributes)" for set_attributes in [true, false]
    ...
    @testset "Basic attributes of dP1" begin
        ...
        @test domain(map_from_torusinvariant_cartier_divisor_group_to_picard_group(dP1)) == cartier_divisor_group(dP1)
        @test codomain(map_from_torusinvariant_cartier_divisor_group_to_picard_group(dP1)) == picard_group(dP1)
        @test domain(map_from_torusinvariant_cartier_divisor_group_to_torusinvariant_weil_divisor_group(dP1)) == cartier_divisor_group(dP1)
    ...
    @testset "Basic attributes of dP2" begin
        ...
        @test domain(map_from_torusinvariant_cartier_divisor_group_to_picard_group(dP2)) == cartier_divisor_group(dP2)
        @test codomain(map_from_torusinvariant_cartier_divisor_group_to_picard_group(dP2)) == picard_group(dP2)
        @test domain(map_from_torusinvariant_cartier_divisor_group_to_torusinvariant_weil_divisor_group(dP2)) == cartier_divisor_group(dP2)
    ...
    @testset "Basic attributes of dP3" begin
        ...
        @test domain(map_from_torusinvariant_cartier_divisor_group_to_picard_group(dP3)) == cartier_divisor_group(dP3)
        @test codomain(map_from_torusinvariant_cartier_divisor_group_to_picard_group(dP3)) == picard_group(dP3)
        @test domain(map_from_torusinvariant_cartier_divisor_group_to_torusinvariant_weil_divisor_group(dP3)) == cartier_divisor_group(dP3)
