...
@testset "symmetrizations" begin
    ...
    @test [exterior_power(chi, 3)[1] for chi in t] == [0, 0, 10, 10, 10, 10, 560, 84, 84, 120, 120]
    @test [symmetric_power(chi, 3)[1] for chi in t] == [1, 1, 35, 35, 35, 35, 816, 165, 165, 220, 220]
