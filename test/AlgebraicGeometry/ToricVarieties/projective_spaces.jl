@testset "(Weighted) projective space" begin
  ...
  WPS3 = weighted_projective_space(NormalToricVariety, [3, 1, 2])
  WPS4 = weighted_projective_space(NormalToricVariety, [3, 45, 68, 7, 15])
  WPS5 = weighted_projective_space(NormalToricVariety, [3, 1, 2, 6, 5, 1, 1, 8])
