@testset "del Pezzo surfaces" begin
  ...
  @testset "Basic attributes of dP1" begin
    ...
    @test codomain(map_from_torusinvariant_cartier_divisor_group_to_picard_group(dP1)) == picard_group_with_map(dP1)[1]
    ...
    @test codomain(map_from_torusinvariant_cartier_divisor_group_to_class_group(dP1)) == class_group_with_map(dP1)[1]
    @test domain(map_from_picard_group_to_class_group(dP1)) == picard_group_with_map(dP1)[1]
    @test codomain(map_from_picard_group_to_class_group(dP1)) == class_group_with_map(dP1)[1]
  ...
  @testset "Basic attributes of dP2" begin
    ...
    @test codomain(map_from_torusinvariant_cartier_divisor_group_to_picard_group(dP2)) == picard_group_with_map(dP2)[1]
    ...
    @test codomain(map_from_torusinvariant_cartier_divisor_group_to_class_group(dP2)) == class_group_with_map(dP2)[1]
    @test domain(map_from_picard_group_to_class_group(dP2)) == picard_group_with_map(dP2)[1]
    @test codomain(map_from_picard_group_to_class_group(dP2)) == class_group_with_map(dP2)[1]
  ...
  @testset "Basic attributes of dP3" begin
    ...
    @test codomain(map_from_torusinvariant_cartier_divisor_group_to_picard_group(dP3)) == picard_group_with_map(dP3)[1]
    ...
    @test codomain(map_from_torusinvariant_cartier_divisor_group_to_class_group(dP3)) == class_group_with_map(dP3)[1]
    @test domain(map_from_picard_group_to_class_group(dP3)) == picard_group_with_map(dP3)[1]
    @test codomain(map_from_picard_group_to_class_group(dP3)) == class_group_with_map(dP3)[1]
