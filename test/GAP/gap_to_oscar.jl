@testset "ZZRingElem" begin
    ...
    x = ZZRingElem(17)
    val = 17
    @test GAP.gap_to_julia(ZZRingElem, val) == x
    ...
    # non-integer
    val = GAP.evalstr("1/2")
    @test_throws GAP.ConversionError GAP.gap_to_julia(ZZRingElem, val)
end
...
@testset "QQFieldElem" begin
    ...
    x = QQFieldElem(17)
    val = 17
    @test GAP.gap_to_julia(QQFieldElem, val) == x
    ...
    # non-rational
    val = GAP.evalstr("()")
    @test_throws GAP.ConversionError GAP.gap_to_julia(QQFieldElem, val)
end
...
@testset "ZZMatrix" begin
    ...
    @test GAP.gap_to_julia(ZZMatrix, val) == x
    @test ZZMatrix(val) == x
    ...
    @test_throws GAP.ConversionError GAP.gap_to_julia(ZZMatrix, val)
end
...
@testset "QQMatrix" begin
    ...
    x = Nemo.QQ[1 2; 3 4]
    val = GAP.evalstr( "[ [ 1, 2 ], [ 3, 4 ] ]" )
    @test GAP.gap_to_julia(QQMatrix, val) == x
    @test QQMatrix(val) == x
    ...
    @test_throws GAP.ConversionError GAP.gap_to_julia(QQMatrix, val)
end
